...
class VisualSonicsTransform
{
  ...
  private:
    ...
    typedef std::vector<ImageDataT> ImageDataT_vector;
    //! image data
    std::vector<ImageDataT>  its_image;
   /*! Coordinate system:
   ...
   */
   //! x positions for the points in the image
    ...
    Interpolation<ImageDataT,CoordT>* its_interpolation;
    ...
    std::vector<ImageDataT> its_transform;
